...
RANKING_RULES = (
    ...
    "incidentes, investigación con resultados, vulnerabilidades de la cadena de\n"
    "suministro o del tooling que obligan a actuar, cambios que rompen compatibilidad o\n"
    "deprecaciones con fecha, y lanzamientos que cambian de verdad cómo se construye algo.\n"
