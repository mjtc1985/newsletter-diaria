...
RANKING_RULES = (
    "ÁMBITO DEL BOLETÍN: va de IA.\n"
    "PASO 1, clasifica el 'tema' de cada artículo:\n"
    "- \"ia\" si la IA es el ASUNTO del artículo: modelos, agentes, herramientas de IA,\n"
    "  construir software con IA o sobre IA, evaluar modelos, seguridad de sistemas de\n"
    "  IA, su coste, sus límites, su regulación, su negocio, o el análisis y la crítica\n"
    "  de todo lo anterior.\n"
    "- \"otro\" en el resto. Que un artículo MENCIONE la IA no lo convierte en \"ia\":\n"
    "  infraestructura, un orquestador o una herramienta que además sirve para cargas de\n"
    "  trabajo de IA sigue siendo \"otro\", porque su asunto es la infraestructura.\n"
    ...
    "de un servicio del que depende medio sector, un cambio que rompe compatibilidad en\n"
    "un lenguaje o framework de uso masivo, el cambio de licencia de un proyecto\n"
    "central, o una sentencia o regulación que cambia cómo se publica software.\n"
    "Un artículo con tema \"otro\" que no llegue a eso va a importance 25 o menos aunque\n"
    "sea excelente: una regresión o un fallo en una biblioteca concreta, una guía, una\n"
    "encuesta, una charla de congreso, novedades de un producto de nicho, o una\n"
    "curiosidad de algoritmos o de historia de la informática.\n"
    ...
    "  deprecian algo con fecha, o son una vulnerabilidad del propio lenguaje o runtime.\n"
    "- Seguridad: solo la que afecta a cómo se construye software, es decir cadena de\n"
    "  suministro, dependencias, secretos, CI/CD y seguridad de agentes de IA.\n"
    "  Vulnerabilidades de kernel, de red o de administración de sistemas puros:\n"
    "  importance 20 o menos.\n"
    "- Hardware, gadgets, consumo, negocio y geopolítica: importance 20 o menos.\n"
    ...
    "SUBE cuando se cumple alguna de estas señales, que valen más que el tema:\n"
    "- Hay un hecho nuevo y comprobable, no una postura ni una intención.\n"
    "- Alguien ha medido algo y da la cifra.\n"
    "- Alguien ha cambiado de decisión y explica por qué: una empresa revierte una\n"
    "  apuesta técnica, cambia de arquitectura o abandona una herramienta.\n"
    "- Hay verificación independiente de lo que afirmó otro. Vale más que el anuncio\n"
    "  original: quien desmiente un benchmark ajeno va por encima de quien lo publicó.\n"
    "- Es la primera vez que ocurre algo.\n"
    "- Un laboratorio lanza un modelo o una herramienta, aunque no te suene el nombre.\n"
    "- Un análisis o un texto didáctico que de verdad enseña algo no obvio. Si es\n"
    "  divulgación estándar de un concepto conocido, no: eso es 40 o menos.\n"
    "BAJA a importance 20 o menos:\n"
    "- El sujeto de la noticia es la propia empresa contando lo bien que le va, o un\n"
    "  caso de cliente, o cómo alguien usa su producto.\n"
    "- El titular es un número de versión.\n"
    "- Es un evento, una inscripción, una ronda de financiación o una contratación.\n"
    "- Entradas de changelog, notas del tipo 'ya disponible en X' y material\n"
    "  promocional sin contenido técnico.\n"
    "- Gobernanza, regulación y política de IA, salvo que impongan obligaciones\n"
    "  concretas a quien desarrolla software. La opinión de un directivo sobre si hay\n"
    "  que regular no es noticia.\n"
...
def build_preselect_prompt(payload: dict, limit: int) -> str:
    return (
        ...
        "Descarta también, por muy de IA que parezcan: el titular en que la empresa habla\n"
        "de sí misma o de un cliente suyo, el que es un número de versión, y el que\n"
        "anuncia un evento, una inscripción, una ronda o una contratación.\n"
        "Prefiere el titular con un hecho o una cifra al que solo expresa una postura.\n"
        "INCLUYE SIEMPRE, aunque por el titular no parezca que va de IA, cuando veas que:\n"
        "- alguien cambia una decisión técnica y dice por qué (abandona una herramienta,\n"
        "  revierte una apuesta, cambia de arquitectura);\n"
        "- algo ocurre por primera vez;\n"
        "- alguien verifica o desmiente lo que afirmó otro;\n"
        "- hay una cifra medida.\n"
        "Estas cuatro pesan más que el tema: el motivo suele estar en el cuerpo del\n"
        "artículo y no en el titular, y aquí solo ves el titular.\n"
