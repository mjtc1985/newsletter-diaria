...
def select_items(
    ...
    # El orden final no es solo la nota: primero lo que pasa o lo que alguien
    # construyo, luego el comentario, y lo ajeno a la IA al final. Son decisiones
    # de posicion, no de inclusion, y una nota sola no sabe expresarlas.
