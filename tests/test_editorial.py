...
class BucketOrderTest(unittest.TestCase):
    """Dos reglas de calibracion piden posicion, no inclusion: lo ajeno a la IA
    entra pero no encabeza, y el comentario va por debajo de lo que pasa."""
    ...
    def test_within_a_bucket_the_score_still_decides(self) -> None:
        candidates = [self._ranked("floja", "Ars Technica", 50, 0),
